  ...
  return (
    <div className='container my-5'>
      <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
        <div className="col"  onClick={() => handleClick('/checklist')}>
          <div className={`${styles.card} card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg`} style={{
            ...
            <div className="d-flex flex-column h-100 p-5 text-white text-shadow-1 user-select-none">
              <h3 className={`${styles.h3} mt-5 mb-5 display-6 lh-base fw-bold text-center`} style={shadow}>일본여행<br/>체크리스트</h3>
            </div>
          </div>
        </div>

        <div className="col" onClick={() => redirect('https://www.google.com/travel/flights?hl=ko')}>
          <div className={`${styles.card} card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg`} style={{
        ...
        <div className="col"  onClick={() => redirect('https://triple.guide/')}>
          <div className={`${styles.card} card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg`} style={{
